...
{
    public class GetPaginatedAidDistributionsQueryValidation : AbstractValidator<GetPaginatedAidDistributionsQuery>
    {
        public GetPaginatedAidDistributionsQueryValidation()
        {
