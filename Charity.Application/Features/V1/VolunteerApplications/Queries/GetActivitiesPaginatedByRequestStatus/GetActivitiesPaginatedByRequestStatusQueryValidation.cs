...
{
    public class GetActivitiesPaginatedByRequestStatusQueryValidation
        : AbstractValidator<GetActivitiesPaginatedByRequestStatusQuery>
    {
        public GetActivitiesPaginatedByRequestStatusQueryValidation()
        {
