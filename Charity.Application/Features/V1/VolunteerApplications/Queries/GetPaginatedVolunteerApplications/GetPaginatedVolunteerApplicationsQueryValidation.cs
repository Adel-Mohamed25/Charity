...
{
    public class GetPaginatedVolunteerApplicationsQueryValidation : AbstractValidator<GetPaginatedVolunteerApplicationsQuery>
    {
        public GetPaginatedVolunteerApplicationsQueryValidation()
        {
